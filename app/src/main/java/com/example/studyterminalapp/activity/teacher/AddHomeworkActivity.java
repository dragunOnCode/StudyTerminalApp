...
public class AddHomeworkActivity extends AppCompatActivity {
    ...
    private Button btnAddHomework, btnOpenDate, btnDeadline;
    ...
    private void initListener() {
        ...
        btnAddHomework.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                paramsMap.put("classId", teacherClass.getCid());
                paramsMap.put("textbookId", teacherClass.getTextbookId());
                ...
                try {
                    RequestManager.getInstance().PostRequest(paramsMap, Constants.HOMEWORK, new RequestManager.ResultCallback() {
                        @Override
            ...
            RequestManager.getInstance().GetRequest(paramsMap, Constants.AVAILABLE_HOMEWORK, new RequestManager.ResultCallback() {
                ...
                public void onResponse(String responseCode, String json) {
                    ...
                    switch (code) {
                        case 200:
                            Log.d("TEST", "JSON: " + json);
                            availableChapter = response.getData();
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
